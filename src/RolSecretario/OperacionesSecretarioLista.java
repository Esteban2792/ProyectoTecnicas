...
public class OperacionesSecretarioLista extends javax.swing.JFrame {
Conexion BaseDatos = new Conexion();
     ...
     */
    public OperacionesSecretarioLista() {
        initComponents();
    }
public void CargarListaOperaciones(){
    ...
    private void initComponents() {
        ...
        jtOperaciones.setAutoCreateRowSorter(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OperacionesSecretarioLista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OperacionesSecretarioLista().setVisible(true);
            }
        });
    }
