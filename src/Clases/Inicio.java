...
public class Inicio extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String url="select nombre, contraseña, tipoDeUsuario from login where estado = 1 and nombre='"+usuario+"'";
       ...
       try{
        ...
        if (MantieneDatos.next()){ //busca fila en la tabla
            ...
            String NombreUsuario = MantieneDatos.getString("nombre");
            ...
            if(contrasena.equals(ContrasenaUsuario)){
                ...
                if (roll.equals("Doctor")){
                    ...
                    Secretario ventanaSecretario = new Secretario();
